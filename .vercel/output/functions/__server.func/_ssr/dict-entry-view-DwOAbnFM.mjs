...
import { n as hanVietOfWord } from "./kanji-set-k3QBvSZq.mjs";
import { n as copyToClipboard } from "./utils-D10sm1uC.mjs";
import { c as kanjiInWord, u as relatedEntries } from "./catalog-D7gOJvrd.mjs";
import { t as Button } from "./button-C9dY86uP.mjs";
import { A as Copy, I as BookmarkPlus, c as Star } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/dict-entry-view-DwOAbnFM.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					...
					wordHv ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-2 text-sm",
						children: ["Hán-Việt: ", wordHv]
					}) : null,
					...
					entry.pitch_accent != null ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: ["Cao độ: ", entry.pitch_accent]
					}) : null,
			...
			kanji.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: kanji.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					...
					children: [k.entry ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						className: "text-sm text-muted",
						children: k.entry ? `${k.entry.han_viet ? `${k.entry.han_viet} · ` : ""}${k.entry.meaning_vi}` : "Chưa có trong bộ kanji N5/N4"
					})]
				}, k.char))
			})] }) }) : null,
