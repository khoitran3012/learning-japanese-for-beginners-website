...
import { t as allKanjiExamples } from "./examples-nNwFwmkA.mjs";
import { t as Button } from "./button-D6esF8zp.mjs";
import { a as Route$8 } from "./router-nloH8-FU.mjs";
...
import { t as AiTutor } from "./ai-tutor-DA7fkRy3.mjs";
import { n as WriteCanvas, t as StrokeOrder } from "./stroke-order-CDRey7pT.mjs";
import { t as Pronunciation } from "./pronunciation-C-grmXdb.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/kanji._id-BlLNQyNK.js
...
function Page() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			usage.tip ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
						...
						children: ["Cách dùng chữ ", k.character]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Onyomi (âm Hán, katakana) thường trong từ ghép. Kunyomi (âm Nhật, hiragana) khi chữ đứng một mình hoặc có okurigana."
					})
				]
			}) }) : null,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AiTutor, { seed: `Giải thích kanji ${k.character} (${k.meaning_vi}): onyomi ${k.onyomi.join("/")} = ${onRows.map((r) => `${r.hira} ${r.romaji}`).join(", ")}, kunyomi ${kunRows.map((r) => `${r.hira} ${r.romaji}`).join(", ")}. Cách dùng: ${usage.tip}` }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
