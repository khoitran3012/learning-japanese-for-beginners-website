//#region node_modules/.nitro/vite/services/ssr/assets/provider-CilpJFiz.js
...
function applyLocalAiFromSettings(s) {
	if (s.aiMode === "local") setAIProvider(new LocalAIProvider({
		url: s.localAiUrl,
	...
	else setAIProvider(new NoopAIProvider());
}
//#endregion
export { getAI as n, applyLocalAiFromSettings as t };
