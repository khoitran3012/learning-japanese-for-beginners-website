...
import { r as useOnlineUsers } from "./online-users-BBePTpBl.mjs";
...
import { i as updateDisplayName, n as listLeaderboard, t as getMyStats } from "./leaderboard-C_g6h7XM.mjs";
import { c as stageLabel, i as countCompletedByStage, n as PATH_STAGES, r as STAGE_TOTALS, t as LESSON_STAGE } from "./path-stages-Js0Sa0fT.mjs";
import { n as listPathRankings, syncPathProgress, t as emptyRankings } from "./sync-path-CcT25a2w.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/leaderboard-wHLXl1c1.js
...
function mergeLocalRankings(rankings, completed, meId, displayName) {
	const base = rankings ? {
	...
	for (const s of PATH_STAGES) {
		...
		base.byStage[s.id] = list.sort((a, b) => b.completed - a.completed || a.displayName.localeCompare(b.displayName, "vi")).map((r, i) => ({
			...r,
			rank: i + 1,
	...
	} else if (overallDone > 0) base.overall.push({
		userId,
		displayName,
	...
	base.overall = base.overall.sort((a, b) => b.completed - a.completed || a.displayName.localeCompare(b.displayName, "vi")).map((r, i) => ({
		...r,
		rank: i + 1,
		isYou: r.userId === userId
	}));
...
function Page() {
	...
	const onlineIds = (0, import_react.useMemo)(() => new Set(online.map((u) => u.userId)), [online]);
	(0, import_react.useEffect)(() => {
		listLeaderboard().then(setRows).catch(() => setRows([]));
		listPathRankings().then((data) => {
			setPathRanks(data);
			setPathError(null);
		}).catch(() => {
			setPathRanks(null);
	...
	const merged = (0, import_react.useMemo)(() => mergeLocalRankings(pathRanks, completed, me?.id ?? null, youName), [
		pathRanks,
		completed,
		me,
		youName
	]);
	const garden = (0, import_react.useMemo)(() => gardenFromLessons(completed, LESSON_STAGE, merged, youId), [
		completed,
		merged,
		youId
	]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		pathError ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mb-4 rounded-[10px] border border-danger/30 bg-danger/8 px-4 py-3 text-sm text-danger",
			children: pathError
		}) : null,
		online.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
			className: "mb-4",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				className: "py-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mb-2 flex items-center gap-2 text-xs font-medium uppercase tracking-[0.14em] text-subtle",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: online.map((u) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [
							...
							u.displayName,
							me && u.userId === me.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
								...
								children: [
									r.displayName,
									r.isYou ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "ml-2 text-xs text-accent",
										children: "bạn"
									}) : null,
									onlineIds.has(r.userId) ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
