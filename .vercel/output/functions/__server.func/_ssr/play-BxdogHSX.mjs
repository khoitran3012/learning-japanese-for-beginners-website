...
//#region node_modules/.nitro/vite/services/ssr/assets/play-BxdogHSX.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		...
		children: deck.map((c) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				className: `flex min-h-[4.5rem] items-center justify-center rounded-[10px] border text-xl ${matched.has(c.pair) ? "border-forest bg-mist font-jp text-fg" : face ? "border-primary bg-surface font-jp text-fg" : "border-border bg-choice text-muted"}`,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: round.map((v) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					...
					children: [v.word, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "ml-2 text-xs font-sans opacity-80",
						children: v.kana
					})]
				}, v.id))
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
