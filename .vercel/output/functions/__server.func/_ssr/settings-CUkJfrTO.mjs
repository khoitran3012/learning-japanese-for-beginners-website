...
import { a as practiceKanji } from "./kanji-set-k3QBvSZq.mjs";
...
import { r as searchLocal, t as buildDictionary } from "./local-C1UW3dwL.mjs";
...
import { n as buttonVariants, t as Button } from "./button-C9dY86uP.mjs";
...
import { t as Textarea } from "./textarea-DVYGMzis.mjs";
import { n as probeLocalAi } from "./local-rpc-D-CZb-As.mjs";
import { t as Label } from "./label-2T3zHwov.mjs";
import { n as issueRecoveryCode, t as hasRecoveryCode } from "./recovery-CqhGUYkM.mjs";
import { t as Switch } from "./switch-DmPARbQm.mjs";
import { i as SliderTrack, n as SliderRange, r as SliderThumb, t as Slider$1 } from "../_libs/@radix-ui/react-slider+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-CUkJfrTO.js
...
var LocalDataProvider = class extends DataProvider {
	...
	async getDictionary() {
		if (!this.dict) {
			...
			this.dict = buildDictionary([...VOCAB_N5, ...VOCAB_N4], practiceKanji(), extra);
		}
		return this.dict;
	}
...
function Slider({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Slider$1, {
		...
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderThumb, { className: "block size-4 rounded-full border-2 border-primary bg-primary-fg shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" })]
	});
}
var AlertDialog = Root2;
var AlertDialogTrigger = Trigger2;
function AlertDialogContent({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Portal2, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Overlay2, { className: "fixed inset-0 z-50 bg-scrim/55" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
		...
		children: [
			...
			user ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					...
					freshCode ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "rounded-[10px] border border-border bg-choice px-3 py-3 text-center font-mono text-lg tracking-wide",
						children: freshCode
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Label, {
						className: "mb-2 block",
						children: ["Thẻ từ mỗi phiên: ", settings.flashcardPerDay]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Slider, {
						min: 5,
						max: 40,
						step: 5,
