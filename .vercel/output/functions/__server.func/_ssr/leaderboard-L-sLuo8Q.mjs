...
import { r as getSql } from "./db-TNeeIBl5.mjs";
import { t as authMiddleware } from "./middleware-yj2MZKDt.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/leaderboard-L-sLuo8Q.js
...
var submitStudyResult = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => ({
	...
	if (!displayName) try {
		const { getSessionUser } = await import("./verify.server-CuekMjdu.mjs");
