...
//#region node_modules/.nitro/vite/services/ssr/assets/online-users-B_g3RJRi.js
...
function OnlineUsersList({ compact = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			className: cn("mb-2 flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.14em] text-muted", compact && "px-3"),
			children: [
