//#region node_modules/.nitro/vite/services/ssr/assets/grammar-categories-CJmstdUW.js
var GRAMMAR_CATEGORY_ORDER = [
	"Thể lịch sự",
	"Trợ từ",
	"Chỉ định",
	"Động từ",
...
function groupGrammar(entries) {
	...
	return GRAMMAR_CATEGORY_ORDER.map((cat) => ({
		cat,
		items: buckets.get(cat)
	})).filter((x) => x.items.length > 0);
}
//#endregion
export { grammarCategory as n, groupGrammar as r, GRAMMAR_CATEGORY_BLURB as t };
