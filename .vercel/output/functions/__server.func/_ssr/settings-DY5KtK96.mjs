...
//#region node_modules/.nitro/vite/services/ssr/assets/settings-DY5KtK96.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Tùy chọn. Học không cần AI. Local chạy trên máy bạn (Ollama hoặc LM Studio). Đám mây chỉ gọi khi bạn bấm hỏi."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex flex-wrap gap-2",
						children: [
