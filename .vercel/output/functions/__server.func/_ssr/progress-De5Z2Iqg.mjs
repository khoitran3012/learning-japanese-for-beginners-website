...
//#region node_modules/.nitro/vite/services/ssr/assets/progress-De5Z2Iqg.js
...
var useProgress = create((set, get) => ({
	...
	completeLesson: async (id) => {
		...
		import("./sync-path-BwYuSrjW.mjs").then(({ syncPathProgress }) => syncPathProgress([...get().completedLessonIds]));
	},
	refreshSets: async () => {
