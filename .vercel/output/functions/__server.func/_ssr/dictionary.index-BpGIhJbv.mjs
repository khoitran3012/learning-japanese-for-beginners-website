...
import { d as rememberImported, h as useDictionary, p as searchDictionary, t as POS_FILTERS } from "./catalog-D7gOJvrd.mjs";
import { t as Button } from "./button-C9dY86uP.mjs";
import { f as Search, u as Sparkles } from "../_libs/lucide-react.mjs";
import { d as createSsrRpc, u as Route$15 } from "./router-sIrB-w_Z.mjs";
...
import { t as DictEntryView } from "./dict-entry-view-DwOAbnFM.mjs";
import { t as PagePager } from "./page-pager-BasewJ9L.mjs";
import { t as EmptyState } from "./empty-state-A1bLnuh-.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dictionary.index-BpGIhJbv.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
		...
		children: results.map((e) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "hidden max-w-28 shrink-0 truncate text-xs text-muted sm:inline",
					children: e.part_of_speech[0]
				}),
