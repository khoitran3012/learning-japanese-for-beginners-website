//#region node_modules/.nitro/vite/services/ssr/assets/db-iW6MThKt.js
...
async function createPgliteSql() {
	globalRef.__pgliteInstance__ ??= (async () => {
		...
		const dataDir = typeof process !== "undefined" && process.env.AKARI_PGLITE_DIR?.trim() || void 0;
		const pg = dataDir ? new PGlite(dataDir, { parsers: {
			[OID_INT8]: Number,
			[OID_DATE]: identity,
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0003_path_progress.sql": _0003_path_progress_default,
			"/migrations/0004_path_rank_view.sql": _0004_path_rank_view_default,
			"/migrations/0005_garden.sql": _0005_garden_default,
			"/migrations/0006_recovery_presence.sql": _0006_recovery_presence_default
		});
