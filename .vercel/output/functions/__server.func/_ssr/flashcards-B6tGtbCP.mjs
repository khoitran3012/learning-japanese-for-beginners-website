...
import { a as findEntry, f as resolveStudyItem, h as useDictionary, i as findBuiltin } from "./catalog-D7gOJvrd.mjs";
import { t as Button } from "./button-C9dY86uP.mjs";
import { n as useSettings } from "./settings-BVK2Ns8d.mjs";
import { i as useProgress, t as isDue } from "./progress-BQrBv4Tb.mjs";
import { t as PageHeader } from "./page-header-CF9mcnZA.mjs";
import { n as meaningParts } from "./answer-check-CQcGeaO2.mjs";
import { t as FlashcardDeck } from "./flashcard-deck-CvL0UqJ1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/flashcards-B6tGtbCP.js
...
function Page() {
	...
	const cards = (0, import_react.useMemo)(() => {
		...
		else if (deck === "kanji") built = practiceKanji().map((k) => ({
			id: k.id,
			front: k.character,
