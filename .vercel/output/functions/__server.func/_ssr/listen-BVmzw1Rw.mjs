...
import { t as syncQuizToLeaderboard } from "./sync-score-DhyLgCmA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/listen-BVmzw1Rw.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
			...
			children: [
				...
				picked !== null ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-[10px] bg-bg-elevated p-3 text-sm",
					children: [
					...
					children: item.options.map((o, idx) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-jp",
								children: o.jp
							}), show ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
