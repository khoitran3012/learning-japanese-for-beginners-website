...
import { h as useDictionary } from "./_ssr/catalog-BH6ywzg_.mjs";
...
import { n as PresenceHeartbeat, t as OnlineUsersList } from "./_ssr/online-users-B_g3RJRi.mjs";
import { n as useSettings, t as initSettingsDom } from "./_ssr/settings-BVK2Ns8d.mjs";
import { i as useProgress } from "./_ssr/progress-BOD7PV7B.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app-BugrByga.js
...
function AppShell({ children }) {
	...
	(0, import_react.useEffect)(() => {
		...
		applyDom();
		load();
		import("./_ssr/catalog-BH6ywzg_.mjs").then((n) => n.r).then((n) => n.r).then((m) => m.fullDictionary());
	}, [applyDom, load]);
	(0, import_react.useEffect)(() => {
