...
import { o as hasGateSessionMarker } from "./_ssr/server-C0TrxcT3.mjs";
...
import { n as foldVi, r as searchLocal } from "./_ssr/local-DrLvRlaq.mjs";
import { t as cn } from "./_ssr/utils-D10sm1uC.mjs";
import { h as useDictionary } from "./_ssr/catalog-B78poYwc.mjs";
...
import { i as useProgress } from "./_ssr/progress-Cu0w4vLw.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/_app-6VkchtBY.js
...
function AppShell({ children }) {
	...
	(0, import_react.useEffect)(() => {
		...
		applyDom();
		load();
		import("./_ssr/catalog-B78poYwc.mjs").then((n) => n.r).then((n) => n.r).then((m) => m.fullDictionary());
	}, [applyDom, load]);
	(0, import_react.useEffect)(() => {
