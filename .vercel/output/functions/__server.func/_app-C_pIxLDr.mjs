...
import { E as require_react, T as require_jsx_runtime, d as DialogClose, f as DialogContent$1, h as DialogTitle$1, m as DialogPortal, p as DialogOverlay, u as Dialog$1 } from "./_libs/@radix-ui/react-alert-dialog+[...].mjs";
...
import { a as hasGateSessionMarker } from "./_ssr/server-BWdmroKK.mjs";
...
import { n as foldVi, r as searchLocal } from "./_ssr/local-D5_3Xz6J.mjs";
import { t as cn } from "./_ssr/utils-D10sm1uC.mjs";
import { m as useDictionary } from "./_ssr/catalog-Ba7ml22_.mjs";
import { t as Button } from "./_ssr/button-D6esF8zp.mjs";
...
import { i as useProgress } from "./_ssr/progress-De5Z2Iqg.mjs";
import { t as applyLocalAiFromSettings } from "./_ssr/provider-CilpJFiz.mjs";
import { t as Input } from "./_ssr/input-qD8XPiq5.mjs";
import { C as GraduationCap, F as BookOpen, I as BookMarked, M as ChartColumn, O as CircleHelp, P as BookText, S as Headphones, b as Languages, c as Sparkles, d as RotateCcw, g as Map$1, h as Menu, i as Trophy, l as Settings, p as PenTool, r as Type, s as Star, t as X, u as Search, v as Library, w as Gamepad2, x as House, y as Layers } from "./_libs/lucide-react.mjs";
import { t as Toaster } from "./_libs/sonner.mjs";
import { t as Provider } from "./_libs/radix-ui__react-tooltip.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_app-C_pIxLDr.js
...
function SearchDialog({ open, onOpenChange }) {
	...
	const results = (0, import_react.useMemo)(() => {
		...
		for (const kj of [...KANJI_N5, ...KANJI_N4]) if (kj.character === query || foldVi(kj.meaning_vi).includes(qFold) || kj.onyomi.some((x) => x.includes(query)) || kj.kunyomi.some((x) => x.includes(query))) out.push({
			type: "Kanji",
			title: kj.character,
			sub: kj.meaning_vi,
			to: `/kanji/${kj.id}`
...
function AppShell({ children }) {
	...
	(0, import_react.useEffect)(() => {
		...
		applyDom();
		load();
		import("./_ssr/catalog-Ba7ml22_.mjs").then((n) => n.r).then((n) => n.r).then((m) => m.fullDictionary());
	}, [applyDom, load]);
	(0, import_react.useEffect)(() => {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sheet, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTitle, { children: "Akari" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "px-2 pb-8",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavLinks, { onNavigate: () => setOpen(false) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-6 px-1",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthSlot, {})
						})]
					})]
