export const LISTENING: Array<{
  ...
  },
  {
    ...
    options: [
      { jp: "「ひ」と読みます。", vi: "Đọc là hi." },
      { jp: "電車を降ります。", vi: "Xuống tàu." },
      { jp: "水をください。", vi: "Cho tôi nước." },
      { jp: "今日は雨です。", vi: "Hôm nay trời mưa." },
    ],
    answerIndex: 0,
  },
  {
    ...
    options: [
      { jp: "かしこまりました。", vi: "Vâng ạ." },
      { jp: "駅はあっちです。", vi: "Ga ở phía kia." },
      { jp: "試験は難しいです。", vi: "Kỳ thi khó." },
      { jp: "本を返してください。", vi: "Hãy trả sách." },
    ],
    answerIndex: 0,
  },
  {
    ...
    options: [
      { jp: "銀行の隣です。", vi: "Cạnh ngân hàng." },
      { jp: "お茶が好きです。", vi: "Tôi thích trà." },
      { jp: "九時に起きます。", vi: "Dậy lúc 9 giờ." },
      { jp: "これは猫です。", vi: "Đây là mèo." },
    ],
    answerIndex: 0,
  },
  {
    ...
    options: [
      { jp: "ええ、大丈夫ですよ。", vi: "Được, không sao." },
      { jp: "富士山は高いです。", vi: "Núi Phú Sĩ cao." },
      { jp: "写真を撮りました。", vi: "Tôi đã chụp ảnh." },
      { jp: "魚を食べません。", vi: "Tôi không ăn cá." },
    ],
    answerIndex: 0,
  },
  {
    ...
    options: [
      { jp: "「に」と読みます。", vi: "Đọc là ni." },
      { jp: "「つき」と読みます。", vi: "Đọc là tsuki." },
      { jp: "「みず」と読みます。", vi: "Đọc là mizu." },
      { jp: "「やま」と読みます。", vi: "Đọc là yama." },
    ],
    answerIndex: 0,
  },
  {
    ...
    options: [
      { jp: "はい、どうぞ。", vi: "Vâng, mời." },
      { jp: "電車です。", vi: "Là tàu điện." },
      { jp: "月曜日です。", vi: "Là thứ Hai." },
      { jp: "高いです。", vi: "Đắt." },
    ],
    answerIndex: 0,
  },
  ...
  },
  {
    ...
    options: [
      { jp: "入口に五人います。", vi: "Ở cửa vào có năm người." },
      { jp: "犬が五匹います。", vi: "Có năm con chó." },
      { jp: "本が五冊あります。", vi: "Có năm quyển sách." },
      { jp: "車が五台あります。", vi: "Có năm chiếc xe." },
    ],
    answerIndex: 0,
  },
  {
    ...
    options: [
      { jp: "三時に始まります。", vi: "Bắt đầu lúc 3 giờ." },
      { jp: "駅で待ちます。", vi: "Đợi ở ga." },
      { jp: "写真を撮ります。", vi: "Chụp ảnh." },
      { jp: "お茶が好きです。", vi: "Thích trà." },
    ],
    answerIndex: 0,
  },
  {
    ...
    options: [
      ...
      { jp: "明日は雨です。", vi: "Mai mưa." },
      { jp: "これは机です。", vi: "Đây là bàn." },
    ],
    answerIndex: 0,
  },
];
